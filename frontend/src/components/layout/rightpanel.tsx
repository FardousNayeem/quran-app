  ...
  return (
    <div className="overflow-hidden">
      <button
        type="button"
        onClick={onToggle}
        className="flex w-full flex-1 items-center px-[26px] py-3 font-medium transition-all"
        style={{
      ...
      {isOpen && (
        <div
          className="space-y-8 px-[26px] pb-4 pt-3"
...
function RangeSlider({
  ...
  const pctValue = `${Number(pct.toFixed(4))}%`;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative flex w-full touch-none select-none items-center">
        ...
        <span
          className="absolute block size-3 -translate-x-1/2 rounded-full"
          style={{
            left: pctValue,
            backgroundColor: "var(--primary)",
          }}
...
export function RightPanel({ settings, onUpdate }: Props) {
  ...
  const ReadingIconOpen = (
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
      <path
        d="M23.83 5.06V18.14C23.83 19.18 22.99 20.15 21.95 20.28L21.59 20.32C19.23 20.64 15.59 21.84 13.51 22.99C13.37 23.08 13.2 23.11 13 23.11V5.74C13.21 5.74 13.41 5.69 13.57 5.59L13.76 5.47C15.69 4.26 19.14 3.1 21.42 2.9H21.48C22.77 2.79 23.83 3.76 23.83 5.06Z"
        fill="currentColor"
      />
      <path
        opacity="0.4"
        d="M13 5.74V23.11C12.82 23.11 12.62 23.08 12.47 22.99L12.43 22.97C10.35 21.83 6.72 20.64 4.37 20.32L4.05 20.28C3.01 20.15 2.17 19.18 2.17 18.14V5.05C2.17 3.76 3.22 2.78 4.51 2.89C6.78 3.08 10.23 4.23 12.15 5.43L12.43 5.59C12.59 5.69 12.79 5.74 13 5.74Z"
        fill="currentColor"
      />
    </svg>
  );
